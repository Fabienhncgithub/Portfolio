...
export interface ApiPhotoPhoto extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Cr\u00E9er une entr\u00E9e Photo par image, puis la publier pour l\u2019afficher sur le portfolio';
    displayName: 'Photo';
    pluralName: 'photos';
    singularName: 'photo';
  };
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['Landscape', 'City', 'Travel', 'Details']
    > &
      Schema.Attribute.DefaultTo<'Details'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    film: Schema.Attribute.String;
